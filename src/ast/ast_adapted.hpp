...
BOOST_FUSION_ADAPT_STRUCT(sre::lua::ast::prefixexpression, first_, rest_)
...
BOOST_FUSION_ADAPT_STRUCT(sre::lua::ast::var, name_)
...
BOOST_FUSION_ADAPT_STRUCT(sre::lua::ast::functioncall, name_, args_)
BOOST_FUSION_ADAPT_STRUCT(sre::lua::ast::stat_functioncall, prefix_, call_)
